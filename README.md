...
>>> b"print('obfucaste')"
>>> b"print('obfucaste')".decode() : "print('obfucaste')"
```
...
print((lambda: (lambda: (lambda: (lambda: (lambda: 'obfucaste')())())())())())
```
...
print((lambda 駹穯污揭: (lambda 駹穯污揭: (lambda 駹穯污揭: 'obfucaste')('駹穯污揭'))((lambda 駹穯污揭: '駹穯污揭')('駹穯污揭')))((lambda 駹穯污揭: (lambda 駹穯污揭: '駹穯污揭')('駹穯污揭'))((lambda 駹穯污揭: '駹穯污揭')('駹穯污揭'))))
```
...
**Thêm `raise`**:
   - `j.body.append(ast.Raise(...))` thêm một câu lệnh `raise` vào trong `except`:
     ...
     - `args=[ast.Str(s="darkz0823")]`: Cung cấp một string tùy chỉnh `"darkz0823"` khi call `MemoryError`.
...
"""
import marshal
x = marshal.dumps(compile(source,"obfucaste.py","exec")
```
...
```py
 ...
 14     >>   62 PUSH_NULL
             ...
             66 PUSH_NULL
             68 LOAD_CONST               3 (<code object <lambda> at 0x0000021F751B16B0, file "obfucaste.py", line 14>)
             70 MAKE_FUNCTION            0
 ...
 16         114 PUSH_NULL
            ...
            118 PUSH_NULL
            120 LOAD_CONST               5 (<code object <lambda> at 0x0000021F74C432D0, file "obfucaste.py", line 16>)
            122 MAKE_FUNCTION            0
            124 PUSH_NULL
            126 LOAD_CONST               6 (<code object <lambda> at 0x0000021F751B1FB0, file "obfucaste.py", line 16>)
            128 MAKE_FUNCTION            0
...
Disassembly of <code object <lambda> at 0x0000021F751B16B0, file "obfucaste.py", line 14>:
 14           0 RESUME                   0
              2 LOAD_CONST               1 ('darkz0823')
              4 RETURN_VALUE

Disassembly of <code object <lambda> at 0x0000021F74C432D0, file "obfucaste.py", line 16>:
 16           0 RESUME                   0
              2 PUSH_NULL
              4 LOAD_CONST               1 (<code object <lambda> at 0x0000021F751B1770, file "obfucaste.py", line 16>)
              6 MAKE_FUNCTION            0
              8 LOAD_CONST               2 ('_0x7359')
             10 PRECALL                  1
             14 CALL                     1
             24 PUSH_NULL
             26 LOAD_CONST               3 (<code object <lambda> at 0x0000021F751B1830, file "obfucaste.py", line 16>)
             28 MAKE_FUNCTION            0
             ...
             46 BINARY_OP                0 (+)
             50 PUSH_NULL
             52 LOAD_CONST               4 (<code object <lambda> at 0x0000021F751B18F0, file "obfucaste.py", line 16>)
             54 MAKE_FUNCTION            0
             ...
             72 BINARY_OP                0 (+)
             76 PUSH_NULL
             78 LOAD_CONST               5 (<code object <lambda> at 0x0000021F751B19B0, file "obfucaste.py", line 16>)
             80 MAKE_FUNCTION            0
             ...
             98 BINARY_OP                0 (+)
            102 PUSH_NULL
            104 LOAD_CONST               6 (<code object <lambda> at 0x0000021F751B1A70, file "obfucaste.py", line 16>)
            106 MAKE_FUNCTION            0
            ...
            124 BINARY_OP                0 (+)
            128 PUSH_NULL
            130 LOAD_CONST               7 (<code object <lambda> at 0x0000021F751B1B30, file "obfucaste.py", line 16>)
            132 MAKE_FUNCTION            0
            ...
            150 BINARY_OP                0 (+)
            154 PUSH_NULL
            156 LOAD_CONST               8 (<code object <lambda> at 0x0000021F751B1BF0, file "obfucaste.py", line 16>)
            158 MAKE_FUNCTION            0
            ...
            176 BINARY_OP                0 (+)
            180 PUSH_NULL
            182 LOAD_CONST               9 (<code object <lambda> at 0x0000021F751B1CB0, file "obfucaste.py", line 16>)
            184 MAKE_FUNCTION            0
            ...
            202 BINARY_OP                0 (+)
            206 PUSH_NULL
            208 LOAD_CONST              10 (<code object <lambda> at 0x0000021F751B1D70, file "obfucaste.py", line 16>)
            210 MAKE_FUNCTION            0
            ...
            228 BINARY_OP                0 (+)
            232 PUSH_NULL
            234 LOAD_CONST              11 (<code object <lambda> at 0x0000021F751B1E30, file "obfucaste.py", line 16>)
            236 MAKE_FUNCTION            0
            ...
            254 BINARY_OP                0 (+)
            258 PUSH_NULL
            260 LOAD_CONST              12 (<code object <lambda> at 0x0000021F751B1EF0, file "obfucaste.py", line 16>)
            262 MAKE_FUNCTION            0
...
Disassembly of <code object <lambda> at 0x0000021F751B1770, file "obfucaste.py", line 16>:
 16           0 RESUME                   0
              2 LOAD_CONST               1 ('h')
              4 RETURN_VALUE

Disassembly of <code object <lambda> at 0x0000021F751B1830, file "obfucaste.py", line 16>:
 16           0 RESUME                   0
              2 LOAD_CONST               1 ('e')
              4 RETURN_VALUE

Disassembly of <code object <lambda> at 0x0000021F751B18F0, file "obfucaste.py", line 16>:
 16           0 RESUME                   0
              2 LOAD_CONST               1 ('l')
              4 RETURN_VALUE

Disassembly of <code object <lambda> at 0x0000021F751B19B0, file "obfucaste.py", line 16>:
 16           0 RESUME                   0
              2 LOAD_CONST               1 ('l')
              4 RETURN_VALUE

Disassembly of <code object <lambda> at 0x0000021F751B1A70, file "obfucaste.py", line 16>:
 16           0 RESUME                   0
              2 LOAD_CONST               1 ('o')
              4 RETURN_VALUE

Disassembly of <code object <lambda> at 0x0000021F751B1B30, file "obfucaste.py", line 16>:
 16           0 RESUME                   0
              2 LOAD_CONST               1 (' ')
              4 RETURN_VALUE

Disassembly of <code object <lambda> at 0x0000021F751B1BF0, file "obfucaste.py", line 16>:
 16           0 RESUME                   0
              2 LOAD_CONST               1 ('w')
              4 RETURN_VALUE

Disassembly of <code object <lambda> at 0x0000021F751B1CB0, file "obfucaste.py", line 16>:
 16           0 RESUME                   0
              2 LOAD_CONST               1 ('o')
              4 RETURN_VALUE

Disassembly of <code object <lambda> at 0x0000021F751B1D70, file "obfucaste.py", line 16>:
 16           0 RESUME                   0
              2 LOAD_CONST               1 ('r')
              4 RETURN_VALUE

Disassembly of <code object <lambda> at 0x0000021F751B1E30, file "obfucaste.py", line 16>:
 16           0 RESUME                   0
              2 LOAD_CONST               1 ('l')
              4 RETURN_VALUE

Disassembly of <code object <lambda> at 0x0000021F751B1EF0, file "obfucaste.py", line 16>:
 16           0 RESUME                   0
              2 LOAD_CONST               1 ('d')
              4 RETURN_VALUE

Disassembly of <code object <lambda> at 0x0000021F751B1FB0, file "obfucaste.py", line 16>:
 16           0 RESUME                   0
